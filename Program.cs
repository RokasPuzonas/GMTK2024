...
internal class Program
{
    ...
    public static int   level1StartingGold = 80;
    public static int   level2StartingGold = 100;
    public static int   level3StartingGold = 100;
    ...
    public static int   revolverCost = 20;
    public static float revolverAimSpeed = (float)Math.PI;
    public static float revolverBulletSpeed = 200;
    public static int   revolverBulletDamage = 15;
    public static int   revolverBulletPierce = 2;
    public static int   revolverBulletSmear = 5;
    public static float revolverBulletKnockback = 20f;
    public static float revolverMinRange = 15f;
    public static float revolverMaxRange = 140f;
    ...
    public static int   bigRevolverBulletDamage = 50;
    ...
    public static float bigRevolverMinRange = 90f;
    public static float bigRevolverMaxRange = 220f;
    ...
    public static float mortarMinRange = 100f;
    public static float mortarMaxRange = 250f;
    ...
    public static int   slimeGoldDrop = 1;
    ...
    public static int   smallSlimeDamage = 2;
    ...
    public static Level CreateLevel2()
    {
        var waves = new List<EnemyWave>
        {
            new([
                ...
                new() { delay = 1f, type = EnemyType.Slime },
                new() { delay = 1f, type = EnemyType.Slime },
                new() { delay = 5f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
            ...
            new([
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
            ...
            new([
                ...
                new() { delay = 2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.4f, type = EnemyType.Slime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.4f, type = EnemyType.Slime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
            ...
            new([
                new() { delay = 0.4f, type = EnemyType.BigSlime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
            ...
            new([
                new() { delay = 1f, type = EnemyType.BigSlime },
                new() { delay = 10f, type = EnemyType.SmallSlime },
                new() { delay = 1f, type = EnemyType.SmallSlime },
                new() { delay = 0.4f, type = EnemyType.Slime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 0.2f, type = EnemyType.SmallSlime },
                new() { delay = 1f, type = EnemyType.Slime },
    ...
    public static Level CreateLevel3()
    {
        var waves = new List<EnemyWave>
        {
          ...
          new([
                new() { delay = 0.8f, type = EnemyType.BigSlime },
                new() { delay = 10f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
                new() { delay = 0.8f, type = EnemyType.Slime },
          ...
          new([
                new() { delay = 6f, type = EnemyType.BigSlime },
                new() { delay = 6f, type = EnemyType.BigSlime },
                new() { delay = 6f, type = EnemyType.BigSlime },
                new() { delay = 6f, type = EnemyType.BigSlime },
                new() { delay = 60f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
          ...
          new([
                ...
                new() { delay = 0.4f, type = EnemyType.Slime },
                new() { delay = 6f, type = EnemyType.BigSlime },
                new() { delay = 6f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
                new() { delay = 0.5f, type = EnemyType.SmallSlime },
          ...
          new([
                new() { delay = 10f, type = EnemyType.BigSlime },
                new() { delay = 10f, type = EnemyType.BigSlime },
                new() { delay = 10f, type = EnemyType.BigSlime },
                new() { delay = 9f, type = EnemyType.BigSlime },
                new() { delay = 9f, type = EnemyType.BigSlime },
                new() { delay = 9f, type = EnemyType.BigSlime },
                new() { delay = 8f, type = EnemyType.BigSlime },
                new() { delay = 8f, type = EnemyType.BigSlime },
                new() { delay = 8f, type = EnemyType.BigSlime },
                new() { delay = 7f, type = EnemyType.BigSlime },
                new() { delay = 7f, type = EnemyType.BigSlime },
                new() { delay = 7f, type = EnemyType.BigSlime },
                new() { delay = 6f, type = EnemyType.BigSlime },
                new() { delay = 6f, type = EnemyType.BigSlime },
